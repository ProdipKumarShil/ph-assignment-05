...
function randColor(id) {
    document.getElementById(id).addEventListener('mouseover', function () {
        ...
        document.getElementById(id).style.backgroundColor = randCol;
        console.log(randCol)
...
randColor('rectangle-card')
randColor('parallelogram-card')
randColor('rhombus-card')
randColor('pentagon-card')
randColor('ellipse-card')
